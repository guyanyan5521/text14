...
<div id="OSC_Banner">
	...
	<div id="portrait"><a href="Welcome/admin_index"><img src="assets/images/portrait.gif" alt="Johnny" title="Johnny" class="SmallPortrait" user="154693" align="absmiddle"></a></div>
    <div id="lnks">
		<strong><?php  if(isset($user)){
            echo $user->username."的博客";}?></strong>
...
<ul>
    <?php foreach ($article as $list){?>
        <li class='Blog' id='blog_24027'>
            ...
            <h2 class='BlogAccess_true BlogTop_0'><a href="Welcome/article_content/<?php echo $list->article_id?>"><?php echo $list->title?></a></h2>

            <div class='outline'>

                <span class='time'>发表于 <?php echo $list->post_date?></span>

                <span class='catalog'>分类: <a href="?catalog=92334"><?php echo $list->type_name?></a></span>

                <span class='stat'>统计: 0评/<?php echo $list->clicked?>阅</span>
                <span class="blog_admin">( <a href="Welcome/new_blog">修改</a> | <a href="javascript:delete_blog(24025)">删除</a> )</span>
            ...
            <div class='TextContent' id='blog_content_24027'>
                ...
                <div class='fullcontent'><a href="Welcome/article_content/<?php echo $list->article_id?>">阅读全文...</a></div>
...
<div class="catalogs SpaceModule">
  ...
  <ul class="LinkLine">
      <?php foreach ($type as $types){?>
          <li><a href="#"><?php echo $types->type_name.'('.$types->num.')'?></a></li>
      <?php }?>
	  </ul>
</div>
