...
<div id="OSC_Banner">
    <div id="OSC_Slogon"><?php
            ...
            echo $article->username."'s Blog";
       ?></div>
    <div id="OSC_Channels">
        <ul>
            <li><a href="#" class="project"><?php echo $article->mood;?></a></li>
    ...
    <div id="lnks">
		<strong>  <?php
                ...
                echo $article->username."的博客";

            ?></strong>
		<div>
			<a href="Welcome/index_login">TA的博客列表</a>&nbsp;|
...
<div class="Blog">
  ...
  <div class="BlogTitle">
      <div class="BlogTitle">
          ...
          <div class="BlogStat">
						<span class="admin">
			<a href="Welcome/new_blog">编辑</a>&nbsp;|&nbsp;<a href="javascript:delete_blog(24026)">删除</a>
		</span>
      ...
      <div class="BlogLinks">
          <ul>
              <?php if(isset($prev)){ ?>
                  <li>上篇 <span>(1小时前)</span>：<a href="welcome/article_content/<?php echo $prev->article_id?>" class="prev"><?php echo $prev->title?></a></li>
              <?php }?>

              <?php if(isset($next)){ ?>
                  <li>下篇 <span>(1小时前)</span>：<a href="welcome/article_content/<?php echo $next->article_id?>" class="prev"><?php echo $next->title?></a></li>
              <?php }?>
    ...
    <div class="BlogMenu"><div class="RecentBlogs SpaceModule">
            <strong>最新博文</strong><ul>
                ...
                <li class="more"><a href="Welcome/index_login">查看所有博文»</a></li>
            </ul>
        </div>
    </div>
    ...
    $(function(){
        $('#btn_comment').on('click',function(){
            ...
            $.get('welcome/add_comment',{
                ...
                if(data == 'success') {
                    location.href = 'Welcome/article_content/<?php echo $article->article_id?>';
                }
