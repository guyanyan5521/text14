...
<div class="MainForm" id="login_page">	
  <form id="frm_login" action="User/login_user" onsubmit="return false" method="POST" style="float:left; width:620px;">
    ...
    <table>
    	<tbody><tr>
    		...
    		<td><input name="email" id="f_email" class="TEXT" style="width: 200px;" type="text" value=""></td>
    	</tr>
    	<tr>
    		<th>登录密码：</th>
    		<td><input name="pwd" id="f_pwd" class="TEXT" style="width: 200px;" type="password" value=""></td>
    	</tr>
    	<tr>
    		<th>&nbsp;</th>
    	...
    	<tr class="buttons">
    		<th>&nbsp;</th>
			<td>
    		<input value="现在登录" class="BUTTON SUBMIT" type="submit" id="sub"/>
			</td>
    	</tr>
