...
<form id="frm_reg" action="User/create" onsubmit="return false" method="POST" style="float:left; width:620px;">
...
<script src="assets/js/getcity.js"></script><span class="nodisp">请选择您所在的地区</span></td>
    	</tr>
    	<tr>
    		<th>验证码：</th>		
    ...
    $(function(){
        ...
        $("#submit").on('click',function () {
            ...
            $.get('User/create', {
                ...
                else if(data == 'pwd_number'){
                    $('#error_msg').html("密码至少四位");
                    $('#error_msg').show("fast");
                }
