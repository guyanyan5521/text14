...
<ul>
    ...
    <div id="AdminContent">
<div class="MainForm">
<form id="BlogForm" action="Welcome/blog_from" method="POST">
<input id="hdn_blog_id" name="draft" value="0" type="hidden">
  ...
  <tr>
	...
	<?php foreach($type as $types){?>
	  <option selected="selected" value="<?php echo $types->type_id?>"><?php echo $types->type_name?></option>

	<?php }?>
		</select>
	<a href="Welcome/blog_catalogs" onclick="return confirm('是否放弃当前编辑进入分类管理？');">分类管理»</a>
	</td>
  </tr>
  <tr><td class='t'>内容（必填） 
