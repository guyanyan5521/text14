...
<style scoped>
  ...
  #order-wait .time-state{
    height:.5rem;
    line-height:.5rem;
    /*background: #FCF8E8;*/
    padding : 0 .1rem;
  }
  #order-wait .order-time{
    float: left;

  }
  #order-wait .order-state{
    float: right;

  }
  #order-wait .order-content{
    height:1.8rem;
    /*border-bottom: .03rem solid #eeeeee;*/
    padding:0 .1rem;
    background: rgba(245,245,245,0.5);
  }
  #order-wait .order-content img{
    display: block;
    float: left;
    width:30%;
    height:1.6rem;
  ...
  #order-wait .order-detail p{
    margin-bottom: .1rem;
  }
  #order-wait .total-price{
    height: 0.5rem;
    width:100%;
    line-height:0.5rem;
    padding-left:4rem;
  ...
  #order-wait .order-state-list span{
